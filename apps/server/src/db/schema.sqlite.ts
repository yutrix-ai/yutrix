...
export const endpointRoutes = sqliteTable(
  "endpoint_routes",
  {
    id: text("id").primaryKey(),
    name: text("name").default(""),
    ...
    fallbackEnabled: integer("fallbackEnabled", { mode: "boolean" })
      .notNull()
      .default(false),
    ...
    fallbackMatchTarget: integer("fallbackMatchTarget", { mode: "boolean" })
      .notNull()
      .default(false),
    fallbackStrategyRoutingEnabled: integer("fallbackStrategyRoutingEnabled", {
      mode: "boolean",
    })
      .notNull()
      .default(false),
    fallbackStrategyRoutingRules: text("fallbackStrategyRoutingRules"),
    strategyRoutingEnabled: integer("strategyRoutingEnabled", { mode: "boolean" })
      .notNull()
      .default(false),
    ...
    status: text("status").default("active"),
    allowClientModel: integer("allowClientModel", { mode: "boolean" })
      .notNull()
      .default(false),
    schedules: text("schedules"),
    ipWhitelist: text("ipWhitelist"),
    timeoutEjectEnabled: integer("timeoutEjectEnabled", { mode: "boolean" })
      .notNull()
      .default(false),
    createdAt: integer("createdAt", { mode: "timestamp" }).notNull(),
    updatedAt: integer("updatedAt", { mode: "timestamp" }).notNull(),
...
export const userRouteOverrides = sqliteTable(
  "user_route_overrides",
  {
    ...
    useClientModel: integer("useClientModel", { mode: "boolean" })
      .notNull()
      .default(false),
    strategyRoutingRules: text("strategyRoutingRules"),
    createdAt: integer("createdAt", { mode: "timestamp" }).notNull(),
...
export const promptInjectionRecords = sqliteTable(
...
export const routeAuthorizations = sqliteTable(
...
export const openapiKeys = sqliteTable(
  "openapi_keys",
  {
    id: text("id").primaryKey(),
    userId: text("userId").notNull(),
...
export const distillationJobs = sqliteTable(
  "distillation_jobs",
  {
    id: text("id").primaryKey(),
...
export const distillationJobItems = sqliteTable(
...
export const distillationLearnedRecords = sqliteTable(
...
export const distillationRoutingProposals = sqliteTable(
...
export const distillationSignalVersions = sqliteTable(
...
export const distillationSkillPackages = sqliteTable(

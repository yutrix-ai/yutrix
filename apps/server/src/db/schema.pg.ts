import { pgTable, text, integer, boolean, doublePrecision, bigint, unique, index } from "drizzle-orm/pg-core";
...
export const distillationJobItems = pgTable("distillation_job_items", {
  id: text("id").primaryKey().notNull(),
...
export const distillationJobs = pgTable("distillation_jobs", {
  id: text("id").primaryKey().notNull(),
...
export const distillationLearnedRecords = pgTable("distillation_learned_records", {
...
export const distillationRoutingProposals = pgTable("distillation_routing_proposals", {
  id: text("id").primaryKey().notNull(),
  jobId: text("jobId").notNull(),
...
export const distillationSignalVersions = pgTable("distillation_signal_versions", {
  id: text("id").primaryKey().notNull(),
...
export const distillationSkillPackages = pgTable("distillation_skill_packages", {
  id: text("id").primaryKey().notNull(),
  userId: text("userId").notNull(),
...
export const endpointRoutes = pgTable("endpoint_routes", {
  id: text("id").primaryKey().notNull(),
  ...
  fallbackStrategyRoutingEnabled: boolean("fallbackStrategyRoutingEnabled").notNull().default(false),
  fallbackStrategyRoutingRules: text("fallbackStrategyRoutingRules"),
  strategyRoutingEnabled: boolean("strategyRoutingEnabled").notNull().default(false),
...
export const openapiKeys = pgTable("openapi_keys", {
  id: text("id").primaryKey().notNull(),
  userId: text("userId").notNull(),
  name: text("name").notNull(),
  keyHash: text("keyHash").notNull(),
...
export const promptInjectionRecords = pgTable("prompt_injection_records", {
  id: text("id").primaryKey().notNull(),
  userId: text("userId").notNull(),
...
export const routeAuthorizations = pgTable("route_authorizations", {
  id: text("id").primaryKey().notNull(),
...
export const userRouteOverrides = pgTable("user_route_overrides", {
  id: text("id").primaryKey().notNull(),
  userId: text("userId").notNull(),
  routeId: text("routeId").notNull(),
